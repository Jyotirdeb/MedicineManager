...
import test.thearch.app.main.medicinemanager.CalendulaActivity;
import test.thearch.app.main.medicinemanager.CalendulaApp;
import test.thearch.app.main.medicinemanager.R;
import test.thearch.app.main.medicinemanager.activities.qrWrappers.PickupWrapper;
import test.thearch.app.main.medicinemanager.activities.qrWrappers.PrescriptionListWrapper;
import test.thearch.app.main.medicinemanager.activities.qrWrappers.PrescriptionWrapper;
...
import test.thearch.app.main.medicinemanager.fragments.ScheduleConfirmationEndFragment;
import test.thearch.app.main.medicinemanager.fragments.ScheduleConfirmationStartFragment;
import test.thearch.app.main.medicinemanager.fragments.ScheduleImportFragment;
import test.thearch.app.main.medicinemanager.persistence.DailyScheduleItem;
import test.thearch.app.main.medicinemanager.persistence.HomogeneousGroup;
...
import test.thearch.app.main.medicinemanager.persistence.Prescription;
...
import test.thearch.app.main.medicinemanager.scheduling.AlarmScheduler;
...
import test.thearch.app.main.medicinemanager.util.Strings;
...
public class ConfirmSchedulesActivity extends CalendulaActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(this,"Error unexpected updating!", Toast.LENGTH_LONG).show();
            finish();
        }
    }
    ...
    private void saveSchedules() {
        ...
        final ProgressDialog progress = ProgressDialog.show(this,"Medicine Manager","Updating guidelines...", true);
    ...
    private class ProcessQRTask extends AsyncTask<String, Integer, Long> {
        ...
        protected void onPostExecute(Long schedules) {
            ...
            if (schedules == -1) {
                Toast.makeText(ConfirmSchedulesActivity.this, "Error unexpected updating!", Toast.LENGTH_LONG).show();
                finish();
            } else if (schedules == 0) {
                Toast.makeText(ConfirmSchedulesActivity.this, "No valid prescriptions were found!", Toast.LENGTH_SHORT).show();
            } else {
                updatePageTitle(0);
