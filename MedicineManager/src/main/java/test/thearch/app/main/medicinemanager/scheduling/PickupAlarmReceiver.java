...
package test.thearch.app.main.medicinemanager.scheduling;
...
import test.thearch.app.main.medicinemanager.activities.PickupNotification;
    ...
    public void onReceive(Context context, Intent intent) {
        {
            ...
            if (action == CalendulaApp.ACTION_CHECK_PICKUPS_ALARM) {
                String description = "Remember to pick up your medicines!";
