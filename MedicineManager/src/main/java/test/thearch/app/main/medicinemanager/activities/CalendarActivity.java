...
import test.thearch.app.main.medicinemanager.scheduling.PickupReminderMgr;
import test.thearch.app.main.medicinemanager.util.AvatarMgr;
import test.thearch.app.main.medicinemanager.util.PickupUtils;
...
public class CalendarActivity extends CalendulaActivity {
                ...
                .setSingleChoiceItems(
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(CalendarActivity.this, "Reminder enabled!", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        }
                )
    ...
    public CharSequence getBestDayText() {
        ...
        CharSequence msg = new SpannableString("There are no medicines to collect");
