...
import test.thearch.app.main.medicinemanager.activities.CalendarActivity;
import test.thearch.app.main.medicinemanager.activities.ConfirmActivity;
import test.thearch.app.main.medicinemanager.activities.LeftDrawerMgr;
import test.thearch.app.main.medicinemanager.activities.MaterialIntroActivity;
import test.thearch.app.main.medicinemanager.activities.MedicinesActivity;
import test.thearch.app.main.medicinemanager.activities.RoutinesActivity;
import test.thearch.app.main.medicinemanager.activities.ScheduleCreationActivity;
import test.thearch.app.main.medicinemanager.activities.SchedulesHelpActivity;
import test.thearch.app.main.medicinemanager.adapters.HomePageAdapter;
import test.thearch.app.main.medicinemanager.database.DB;
import test.thearch.app.main.medicinemanager.events.PersistenceEvents;
import test.thearch.app.main.medicinemanager.fragments.DailyAgendaFragment;
import test.thearch.app.main.medicinemanager.fragments.HomeProfileMgr;
import test.thearch.app.main.medicinemanager.fragments.MedicinesListFragment;
import test.thearch.app.main.medicinemanager.fragments.RoutinesListFragment;
import test.thearch.app.main.medicinemanager.fragments.ScheduleListFragment;
...
import test.thearch.app.main.medicinemanager.scheduling.DailyAgenda;
import test.thearch.app.main.medicinemanager.services.PopulatePrescriptionDBService;
import test.thearch.app.main.medicinemanager.util.FragmentUtils;
import test.thearch.app.main.medicinemanager.util.IconUtils;
import test.thearch.app.main.medicinemanager.util.Snack;
...
public class HomePagerActivity extends CalendulaActivity implements
    ...
    public void enableOrDisablePharmacyMode() {
        ...
        if (CalendulaApp.isPharmaModeEnabled(getApplicationContext())) {
            ...
            Snack.show("You just disabled the pharmacy mode!", HomePagerActivity.this);
    ...
    private void updateTitle(int page) {
        ...
        switch (page) {
            case 1:
                title = getString(R.string.title_activity_routines) + " for " + activePatient.name();
                break;
            case 2:
                title = getString(R.string.title_activity_medicines) + " for " + activePatient.name();
                break;
            case 3:
                title = getString(R.string.title_activity_schedules) + " for " + activePatient.name();
                break;
            default:
    ...
    public class PopulatePrescriptionDatabaseTask extends AsyncTask<String, String, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Snack.show("You just enabled pharmacy mode!", HomePagerActivity.this);
