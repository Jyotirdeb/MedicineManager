...
import test.thearch.app.main.medicinemanager.database.migrationHelpers.LocalDateMigrationHelper;
...
import test.thearch.app.main.medicinemanager.persistence.HtmlCacheEntry;
    ...
    public void dropAndCreateAllTables() {
        ...
        for (Class<?> c : persistedClasses) {
            ...
            try {
                ...
                // ignore
                Log.e(TAG, "Error dropping table " + c.getSimpleName());
            }
