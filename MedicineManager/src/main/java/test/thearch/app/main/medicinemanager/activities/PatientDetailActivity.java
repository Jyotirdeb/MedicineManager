...
import test.thearch.app.main.medicinemanager.DefaultDataGenerator;
...
//    TextView selectAvatarMsg;
    ...
    void lookForQrData(Intent i){
        ...
        if(qrData!=null){
            ...
            Snack.show("User is successfully linked!", this, Snackbar.SnackbarDuration.LENGTH_LONG);
    ...
    private void showUnlinkPatientDialog() {
        ...
        builder.setMessage("Disconnecting this user will stop the tracking. Are you sure you want to continue?")
                .setCancelable(true)
                .setTitle("Be careful")
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_done:
                ...
                if(!TextUtils.isEmpty(patient.name())){
                    ...
                    Snack.show("Please enter a name, please.", this);
                }
                return true;
