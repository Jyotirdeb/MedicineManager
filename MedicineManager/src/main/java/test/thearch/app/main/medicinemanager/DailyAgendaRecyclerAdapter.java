...
import test.thearch.app.main.medicinemanager.util.DailyAgendaItemStub;
import test.thearch.app.main.medicinemanager.util.DailyAgendaItemStub.DailyAgendaItemStubElement;
import test.thearch.app.main.medicinemanager.util.ScreenUtils;
import test.thearch.app.main.medicinemanager.util.view.ParallaxImageView;
